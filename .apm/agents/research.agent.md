...
- If `scope` is **read-only**: do not edit any files (including `1-PROGRESS.md`); return findings to the orchestrator.
...
- Never edit `1-PROGRESS.md` during parallel runs; the orchestrator is the single writer.

## Required Outputs

- `2-RESEARCH.md`: Evidence-backed findings and alternatives
